...
**Competición en Barcelona:** La cuota de inscripción es de 2,000 euros
y el coste de transporte es bajo ya que no saldrían de España,
...
**Competición en Hockenheim (Alemania):** Es una de la competición más
prestigiosa, esto se ve reflejado en su cuota de inscripción que es de
3,500 euros. Además el coste de transporte debido a las escasas
...
**Competición en Assen (Paises Bajos):** El coste de inscripción es
...
**Por tanto, en el caso desfavorable, selecciono la alternativa d2.**
...
***CONCLUSIÓN FINAL:*** En el escenario favorable, es decir,
...
***CONCLUSIÓN FINAL:*** En el escenario desfavorable, es decir,
considerando que los datos son costes, podemos observar que
...
-   **Fondos de bienes raíces**: bajo un mercado alcista podrían
    proporcionar un rendimiento de 10 millones, en un mercado estable 6
    millones, y en un escenario bajista 2 millones.

-   **Criptomonedas**: en un mercado alcista su rentabilidad podría
...
***CONCLUSIÓN***: Podemos observar que, mayoritariamente la mejor
alternativa serían las criptomonedas. Tan solo en el criterio de Wald,
se obtiene que la mejor alternativa serían los bonos del gobierno.
...
los márgenes de ganancia serán bajos, con una ganancia o pérdida del 5%.
...
obtener una ganancia del 12% si la tendencia continúa, o perder un 8% si
la tendencia no se mantiene.
...
ganancia del 20% si la economía es favorable, pero podrían perder un 15%
si la economía se desacelera. Claudia es más conservadora y prefiere
minimizar los riesgos, mientras que Mario está dispuesto a asumir más
riesgos confiando en que la economía mejorará.
